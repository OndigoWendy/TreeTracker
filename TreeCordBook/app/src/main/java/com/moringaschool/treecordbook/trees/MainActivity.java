...
import com.moringaschool.treecordbook.BuildConfig;
...
public class MainActivity extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener {
    ...
    private void WeatherByCityName(String city){
        ...
        Request request=new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/forecasts?q="+city+"&APPID=800c1063c780deb3d182af26145272c5")
//                .url("https://api.openweathermap.org/data/2.5/forecast?q="+city+"&appid=800c1063c780deb3d182af26145272c5)
                .get().build();
    ...
    private void WeatherByLatLon(String lat,String lon){
        OkHttpClient client=new OkHttpClient();
        Request request=new Request.Builder()
                .url("https://api.openweathermap.org/data/2.5/forecasts?lat="+lat+"&lon="+lon+"&APPID=800c1063c780deb3d182af26145272c5")
